...
public class TestDeveloperProductivity {
  ...
  public String getLoginFormDetails(String cobrandSessionToken, String userSessionToken) {
    DefaultHttpClient httpclient = new DefaultHttpClient();
    ...
    try {
      ...
      pm.addParameter("contentServiceId.objectInstanceType", "java.lang.Long");
  ...
  public String transactionSearchService(String cobrandSessionToken, String userSessionToken, String containerType,
      String higherFetchLimit, String lowerFetchLimit, String endNumber, String startNumber, String clientId,
      String clientName, String currencyCode, String fromDate, String toDate, String transactionSplitType,
      String ignoreUserInput) {
    // String userSessionToken=null;
    DefaultHttpClient httpclient = new DefaultHttpClient();
  ...
  public String getItemSummaries(String cobrandSessionToken, String userSessionToken) {
    // String userSessionToken=null;
    DefaultHttpClient httpclient = new DefaultHttpClient();
    ...
    try {
      ...
      /*
       * String source=pm.getResponseBodyAsString(); JSONObject jsonObject= new JSONObject(source);
       * JSONObject userContext= jsonObject.getJSONObject("userContext"); JSONObject userConvCreds=
       * userContext.getJSONObject("conversationCredentials"); userSessionToken= (String)
       * userConvCreds.get("sessionToken");
       */
  ...
  public String getItemSummariesForSite(String cobrandSessionToken, String userSessionToken) {
    // String userSessionToken=null;
    DefaultHttpClient httpclient = new DefaultHttpClient();
  ...
  public String getAllSites(String cobrandSessionToken, String userSessionToken) {
    DefaultHttpClient httpclient = new DefaultHttpClient();
  ...
  public String addSiteAccount(String cobrandSessionToken, String userSessionToken) {
    DefaultHttpClient httpclient = new DefaultHttpClient();
  ...
  public String getSiteInfo(String cobrandSessionToken, String userSessionToken) {
    DefaultHttpClient httpclient = new DefaultHttpClient();
  ...
  public String getPopularSites(String cobrandSessionToken, String userSessionToken) {
    DefaultHttpClient httpclient = new DefaultHttpClient();
