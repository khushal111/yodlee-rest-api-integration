...
public class InvestmentDataDB {
  ...
  public void persistInDB(SiteAccount siteAccount) {
    ...
    try { // Step 2 - register and load the driver Class.forName(JDBC_DRIVER);
      ...
      InvestmentData investmentData = siteAccount.getInvestmentData();
      System.out.println("sql=" + sql);
//      System.out.println("itemId=" + investmentData.getItemId());
      prepStatement = connection.prepareStatement(sql);
      prepStatement.setInt(1, investmentData.getItemId());
      prepStatement.setString(2, "101"); // TODO link user
      prepStatement.setInt(3, investmentData.getAccountType()); 
      prepStatement.setString(4, investmentData.getAccountNumber());
      prepStatement.setString(5, investmentData.getAccountName());
      prepStatement.setString(6, investmentData.getAccountClassification());
      prepStatement.setString(7, investmentData.getPlanName());
      prepStatement.setString(8, investmentData.getAsOf().toString());// TODO convert to date
      prepStatement.setDouble(9, investmentData.getCash());
      prepStatement.setDouble(10, investmentData.getMarginBalance());
      prepStatement.setDouble(11, investmentData.getTotalBalance());
      prepStatement.setDouble(12, investmentData.getTotalVestedBalance());
      prepStatement.setString(13, investmentData.getAccountHolder());
      prepStatement.setDouble(14, investmentData.getMoneyMarketBalance());
      prepStatement.setDouble(15, ((investmentData.getAccruedInterest() == null)? 0.00 : investmentData.getAccruedInterest()));
      prepStatement.setString(16, "null"); // yodlee account status id
      prepStatement.setDouble(17, investmentData.getTotalUnVestedBalance());
      prepStatement.setDouble(18, investmentData.getTotalVestedBalance());
      prepStatement.setDouble(19, investmentData.getT401kLoan());
      prepStatement.setString(20, (investmentData.getSecondaryAccountHolderName()== null) ? "null":investmentData.getSecondaryAccountHolderName() );
      prepStatement.setString(21, (investmentData.getLinkedBankAccountNumber()== null) ? "null":investmentData.getLinkedBankAccountNumber());
      prepStatement.setString(22, (investmentData.getNomineeName()== null) ? "null":investmentData.getNomineeName());
      prepStatement.setString(23, (investmentData.getAccountOpenDate() == null) ? "null":investmentData.getAccountOpenDate().toString());
      prepStatement.setString(24, (investmentData.getAccountCloseDate() == null) ? "null":investmentData.getAccountCloseDate().toString());
      prepStatement.setString(25, investmentData.getPlanNumber());
      prepStatement.setString(26, (investmentData.getMutualFundFolioNumber()== null) ? "null":investmentData.getMutualFundFolioNumber());
      prepStatement.setString(27, (investmentData.getAnnuityBalance()== null) ? "null":investmentData.getAnnuityBalance());
      prepStatement.setDouble(28, (investmentData.getAnnuityDeathBenefit()== null) ? 0.0 :investmentData.getAnnuityDeathBenefit());
      prepStatement.setDouble(29, (investmentData.getCashOptionBuyingPower()== null) ? 0.0 :investmentData.getCashOptionBuyingPower());
      prepStatement.setDouble(30, (investmentData.getDayTradingMarginBuyingPower()== null) ? 0.0 :investmentData.getDayTradingMarginBuyingPower());
      prepStatement.setDouble(31, (investmentData.getDividendEarnedAsPayOut()== null) ? 0.0 :investmentData.getDividendEarnedAsPayOut());
      prepStatement.setDouble(32, investmentData.getShortBalance());
      prepStatement.setInt(33, investmentData.getYodleeInvestmentDataID());
